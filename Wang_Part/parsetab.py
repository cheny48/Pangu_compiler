...
_lr_productions = [
  ...
  ('simple_expression -> ( expression )','simple_expression',3,'p_expression_group','panguyacc.py',44),
  ('simple_expression -> INT_LIT','simple_expression',1,'p_expression_int_literal','panguyacc.py',48),
  ('simple_expression -> FLOAT_LIT','simple_expression',1,'p_expression_float_literal','panguyacc.py',52),
  ('simple_expression -> FALSE','simple_expression',1,'p_expression_bool_literal','panguyacc.py',56),
  ('simple_expression -> TRUE','simple_expression',1,'p_expression_bool_literal','panguyacc.py',57),
  ('simple_expression -> CHAR_LIT','simple_expression',1,'p_expression_char_literal','panguyacc.py',64),
  ('simple_expression -> STRING_LIT','simple_expression',1,'p_expression_string_literal','panguyacc.py',68),
  ('reference -> ID_DOT reference','reference',2,'p_reference1','panguyacc.py',72),
  ('reference -> ID','reference',1,'p_referene2','panguyacc.py',76),
  ('simple_expression -> reference','simple_expression',1,'p_expression_reference','panguyacc.py',80),
  ('init -> = expression','init',2,'p_init1','panguyacc.py',98),
  ('init -> <empty>','init',0,'p_init1','panguyacc.py',99),
  ('init -> PASSIG expression','init',2,'p_init2','panguyacc.py',110),
]
